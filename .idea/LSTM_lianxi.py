...
class LSTMRNN(object):
    ...
    def add_input_layer(self,):
        l_in_x = tf.reshape(self.xs, [-1, self.input_size], name='3_2D')
    ...
    def add_output_layer(self):
        ...
        l_out_x = tf.reshape(self.cell_outputs,[-1,self.cell_size], name='3_2D')
    ...
    def compute_cost(self):
        losses = tf.contrib.legacy_seq2seq.sequence_loss_by_example(
            ...
            softmax_loss_function=self.ms_error,#误差计算函数
            name='losses'
        )
